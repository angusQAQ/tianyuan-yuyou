  ...
  L2_reorder_sentence: {
    ...
    itemsByDiff: {
      ...
      hard: [
        ...
        {
          prompt: '請把下列字詞排成一句通順的話。',
          speak: '雖然今次考試失敗，但是他並不灰心。',
          hint: '先排「雖然……但是……」。',
          hints: ['失敗後用「但是」轉折。', '標點各佔一塊。'],
          order: ['雖然', '今次', '考試', '失敗', '，', '但是', '他', '並不', '灰心', '。'],
    ...
    itemsByDiff: {
      easy: [
        ...
        },
        {
          ...
          explainWrong: "勿選禁配（夜晚、操場、食飯等）；須合圖且時間詞後有「，」。"
        },
        {
          id: "l5e05",
        ...
        },
        {
          ...
          explainWrong: "勿選禁配（夜晚臨睡、學校、食飯等）；須合圖且時間詞後有「，」。"
        },
        {
          id: "l5e10",
        ...
        },
        {
          ...
          explainWrong: "勿選禁配（夜晚、課室、食飯等）；須合圖且時間詞後有「，」。"
        },
        {
          id: "l5e14",
        ...
        },
        {
          ...
          explainWrong: "勿選禁配（夜晚、公園、食飯等）；須合圖且時間詞後有「，」。"
        },
        {
          id: "l5e18",
        ...
        },
        {
          ...
          explainWrong: "勿選禁配（夜晚、博物館、食蛋糕等）；須合圖且時間詞後有「，」。"
        },
        {
          id: "l5e25",
...
export const SPEAK_TTS = {
  ...
  '今次': 'audio/tts/t_fa74f7a982af.mp3',
  ...
  '雖然今次考試失敗，但是他並不灰心。': 'audio/tts/t_d689f78fc132.mp3',
...
export const SPEAK_TTS_MALE = {
  ...
  '雖然今次考試失敗，但是他並不灰心。': 'audio/tts/m_d689f78fc132.mp3',
